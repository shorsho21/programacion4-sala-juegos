...
export const routes: Routes = [
...

  {
    path: 'home',
    loadComponent: () =>
      import('./components/bienvenida/bienvenida.component').then((m) => m.BienvenidaComponent),
  },
...

  {
    path: 'quien-soy',
    loadComponent: () =>
      import('./components/quien-soy/quien-soy.component').then((m) => m.QuienSoyComponent),
  },
...

  {
    path: 'mayor-menor',
    loadComponent: () =>
      import('./components/mayor-menor/mayor-menor').then((m) => m.MayorMenorComponent),
    canActivate: [authGuard],
  },
...

  {
    path: 'preguntados',
    loadComponent: () =>
      import('./components/preguntados/preguntados').then((m) => m.PreguntadosComponent),
    canActivate: [authGuard],
  },
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./components/resultado-encuesta/resultado-encuesta').then(
